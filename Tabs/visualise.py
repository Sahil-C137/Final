...
def app(df, X, y):
    ...
    if st.checkbox("Show Scatter Plot"):
        ...
        sns.scatterplot(ax=axis[0, 0], data=df, x='Jitter_local', y='Jitter_local_absolute', hue='status')
        ...
        sns.scatterplot(ax=axis[1, 0], data=df, x='Jitter_local', y='Jitter_local_absolute', hue='status')
    ...
    if st.checkbox("Display Boxplot"):
        ...
        df.boxplot(['Jitter_local', 'Jitter_local_absolute', 'Jitter_rap', 'Jitter_ppq5'], ax=ax)
        st.pyplot()
